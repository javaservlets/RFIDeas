 ...
 * @since AM 5.5.0
 */
public class BadgeScanPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(BadgeScanPlugin.currentVersion,
				Collections.singletonList(BadgeScan.class));
	}
	...
	public String getPluginVersion() {
		return BadgeScanPlugin.currentVersion;
	}
}
